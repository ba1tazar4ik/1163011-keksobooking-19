...
(function () {
  ...
  function generateAdvertisement(index) { // создаем объект обьявления
    var locationX = window.util.getRandomInteger(0, window.globalVariables.mapPinsBlock.offsetWidth);
    ...
    return {
      ...
      offer: {
        ...
        features: window.util.getArrayRandomLength(window.globalVariables.advertisementFeatures),
  ...
  window.data = function generateAdvertisements(advertisementsQuantity) { // создаем массив обявлений
